...
:Returns:
	 ...
	 =======  ====================================================
	 -EBUSY   PMUv3 already initialized, or filter already present
...
systems where there are at least two CPU PMUs on the system. All VCPUs have
the same PMU. It isn't possible to set a PMU if a PMU event filter is already
present.
