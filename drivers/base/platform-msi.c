...
static void platform_msi_set_shared(msi_alloc_info_t *arg)
{
	arg->flags |= MSI_ALLOC_FLAGS_SHARED_DEVICE;
}
#else
#define platform_msi_set_desc		NULL
#define platform_msi_init		NULL
#define platform_msi_set_shared(x)	do {} while(0)
#endif
				    ...
				    void *host_data)
{
	...
	platform_msi_set_shared(&data->arg);
