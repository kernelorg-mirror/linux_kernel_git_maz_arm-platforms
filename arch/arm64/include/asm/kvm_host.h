...
struct kvm_cpu_context {
	...
	/* Yes, this is terrible absolutely terrible */
	u64 __aligned(SZ_4K) vncr_array[SZ_4K / sizeof(u64)];
};
					     ...
					     int cpu)
{
	...
	ctxt_sys_reg(cpu_ctxt, MPIDR_EL1) = cpu_logical_map(cpu);
}
