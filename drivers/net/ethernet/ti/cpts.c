...
static void cpts_clk_unregister_mux(void *data)
{
	clk_hw_unregister_mux(data);
}

static void cpts_clk_del_provider(void *data)
{
...
static int cpts_of_mux_clk_setup(struct cpts *cpts, struct device_node *node)
{
	...
	ret = devm_add_action_or_reset(cpts->dev, cpts_clk_unregister_mux,
				       clk_hw);
	if (ret) {
